...
public class CompanyRepository : ICompanyRepository
{
    ...
    public CompanyRepository(IApplicationDbContext db) => _db = db;
...
public class BranchRepository : IBranchRepository
{
    ...
    private readonly IApplicationDbContext _db;
    public BranchRepository(IApplicationDbContext db) => _db = db;
...
public class RoleRepository : IRoleRepository
{
    private const short Deleted = 0;
    private readonly IApplicationDbContext _db;
    public RoleRepository(IApplicationDbContext db) => _db = db;
...
public class UserBranchRepository : IUserBranchRepository
{
    private const short Active = 1, Deleted = 0;
    private readonly IApplicationDbContext _db;
    public UserBranchRepository(IApplicationDbContext db) => _db = db;
...
public class UserCompanyRepository : IUserCompanyRepository
{
    private const short Deleted = 0;
    private readonly IApplicationDbContext _db;
    public UserCompanyRepository(IApplicationDbContext db) => _db = db;
...
public class SysRoleBranchRepository : ISysRoleBranchRepository
{
    private const short Deleted = 0;
    private readonly IApplicationDbContext _db;
    public SysRoleBranchRepository(IApplicationDbContext db) => _db = db;
...
public class RolePermissionRepository : IRolePermissionRepository
{
    private const short Deleted = 0;
    private readonly IApplicationDbContext _db;
    public RolePermissionRepository(IApplicationDbContext db) => _db = db;
...
public class SysModuleRepository : ISysModuleRepository
{
    private const short Deleted = 0;
    private readonly IApplicationDbContext _db;
    public SysModuleRepository(IApplicationDbContext db) => _db = db;
...
public class SysSubmoduleRepository : ISysSubmoduleRepository
{
    private const short Deleted = 0;
    private readonly IApplicationDbContext _db;
    public SysSubmoduleRepository(IApplicationDbContext db) => _db = db;
...
public class MenuRepository : IMenuRepository
{
    private const short Active = 1, Deleted = 0;
    private readonly IApplicationDbContext _db;
    public MenuRepository(IApplicationDbContext db) => _db = db;
...
public class EnrollMenuRepository : IEnrollMenuRepository
{
    private const short Deleted = 0;
    private readonly IApplicationDbContext _db;
    public EnrollMenuRepository(IApplicationDbContext db) => _db = db;
...
public class CurrencyRepository : ICurrencyRepository
{
    private const short Deleted = 0;
    private readonly IApplicationDbContext _db;
    public CurrencyRepository(IApplicationDbContext db) => _db = db;
...
public class VatTaxRepository : IVatTaxRepository
{
    private const short Deleted = 0;
    private readonly IApplicationDbContext _db;
    public VatTaxRepository(IApplicationDbContext db) => _db = db;
...
public class CostCenterRepository : ICostCenterRepository
{
    private const short Deleted = 0;
    private readonly IApplicationDbContext _db;
    public CostCenterRepository(IApplicationDbContext db) => _db = db;
...
public class SettingRepository : ISettingRepository
{
    private const short Deleted = 0;
    private readonly IApplicationDbContext _db;
    public SettingRepository(IApplicationDbContext db) => _db = db;
...
public class FinYearRepository : IFinYearRepository
{
    private const short Deleted = 0;
    private readonly IApplicationDbContext _db;
    public FinYearRepository(IApplicationDbContext db) => _db = db;
...
public class FinYearDtlRepository : IFinYearDtlRepository
{
    private const short Deleted = 0;
    private readonly IApplicationDbContext _db;
    public FinYearDtlRepository(IApplicationDbContext db) => _db = db;
...
public class ExchangeRateRepository : IExchangeRateRepository
{
    private const short Active = 1, Deleted = 0;
    private readonly IApplicationDbContext _db;
    public ExchangeRateRepository(IApplicationDbContext db) => _db = db;
...
public class DocSequenceRepository : IDocSequenceRepository
{
    private const short Deleted = 0;
    private readonly IApplicationDbContext _db;
    public DocSequenceRepository(IApplicationDbContext db) => _db = db;
...
public class ApprovalScopeRepository : IApprovalScopeRepository
{
    private const short Deleted = 0;
    private readonly IApplicationDbContext _db;
    public ApprovalScopeRepository(IApplicationDbContext db) => _db = db;
...
public class ApprovalStepRepository : IApprovalStepRepository
{
    private const short Active = 1, Deleted = 0;
    private readonly IApplicationDbContext _db;
    public ApprovalStepRepository(IApplicationDbContext db) => _db = db;
...
{
    private readonly IApplicationDbContext _db;
    public StepApproverRepository(IApplicationDbContext db) => _db = db;
...
public class ApprovalRequestRepository : IApprovalRequestRepository
{
    ...
    private readonly IApplicationDbContext _db;
    public ApprovalRequestRepository(IApplicationDbContext db) => _db = db;
...
{
    private readonly IApplicationDbContext _db;
    public ApprovalRequestStepRepository(IApplicationDbContext db) => _db = db;
...
public class SysFileRepository : ISysFileRepository
{
    private const short Deleted = 0;
    private readonly IApplicationDbContext _db;
    public SysFileRepository(IApplicationDbContext db) => _db = db;
...
{
    private readonly IApplicationDbContext _db;
    public SysAuditLogRepository(IApplicationDbContext db) => _db = db;
...
{
    private readonly IApplicationDbContext _db;
    public LoginAttemptRepository(IApplicationDbContext db) => _db = db;
...
{
    private readonly IApplicationDbContext _db;
    public SysSessionRepository(IApplicationDbContext db) => _db = db;
...
{
    private readonly IApplicationDbContext _db;
    public SysLogRepository(IApplicationDbContext db) => _db = db;
...
{
    private readonly IApplicationDbContext _db;
    public EventOutboxRepository(IApplicationDbContext db) => _db = db;
