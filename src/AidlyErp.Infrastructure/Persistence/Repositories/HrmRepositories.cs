...
namespace AidlyErp.Infrastructure.Persistence.Repositories;
...
public class HrmDepartmentRepository : IHrmDepartmentRepository
{
    ...
    public HrmDepartmentRepository(IApplicationDbContext db) => _db = db;
...
{
    private readonly IApplicationDbContext _db;
    public HrmDesignationRepository(IApplicationDbContext db) => _db = db;
...
{
    private readonly IApplicationDbContext _db;
    public HrmEmployeeRepository(IApplicationDbContext db) => _db = db;
...
{
    private readonly IApplicationDbContext _db;
    public HrmShiftRepository(IApplicationDbContext db) => _db = db;
...
{
    private readonly IApplicationDbContext _db;
    public HrmGradeRepository(IApplicationDbContext db) => _db = db;
...
{
    private readonly IApplicationDbContext _db;
    public HrmGradeStepRepository(IApplicationDbContext db) => _db = db;
...
{
    private readonly IApplicationDbContext _db;
    public HrmLeaveTypeRepository(IApplicationDbContext db) => _db = db;
...
{
    private readonly IApplicationDbContext _db;
    public HrmHolidayRepository(IApplicationDbContext db) => _db = db;
...
{
    private readonly IApplicationDbContext _db;
    public HrmSalaryComponentRepository(IApplicationDbContext db) => _db = db;
...
{
    private readonly IApplicationDbContext _db;
    public HrmPayrollPolicyRepository(IApplicationDbContext db) => _db = db;
...
{
    private readonly IApplicationDbContext _db;
    public HrmTaxSlabRepository(IApplicationDbContext db) => _db = db;
...
{
    private readonly IApplicationDbContext _db;
    public HrmAttendanceRepository(IApplicationDbContext db) => _db = db;
...
{
    private readonly IApplicationDbContext _db;
    public HrmAttendanceAdjustmentRepository(IApplicationDbContext db) => _db = db;
...
{
    private readonly IApplicationDbContext _db;
    public HrmShiftRosterRepository(IApplicationDbContext db) => _db = db;
...
{
    private readonly IApplicationDbContext _db;
    public HrmShiftRosterLineRepository(IApplicationDbContext db) => _db = db;
...
{
    private readonly IApplicationDbContext _db;
    public HrmOvertimeRepository(IApplicationDbContext db) => _db = db;
...
{
    private readonly IApplicationDbContext _db;
    public HrmEmployeeMovementRepository(IApplicationDbContext db) => _db = db;
...
{
    private readonly IApplicationDbContext _db;
    public HrmSalaryStructureRepository(IApplicationDbContext db) => _db = db;
...
{
    private readonly IApplicationDbContext _db;
    public HrmSalaryStructureDtlRepository(IApplicationDbContext db) => _db = db;
...
{
    private readonly IApplicationDbContext _db;
    public HrmPayrollRunRepository(IApplicationDbContext db) => _db = db;
...
{
    private readonly IApplicationDbContext _db;
    public HrmPayslipRepository(IApplicationDbContext db) => _db = db;
...
{
    private readonly IApplicationDbContext _db;
    public HrmPayslipDtlRepository(IApplicationDbContext db) => _db = db;
...
{
    private readonly IApplicationDbContext _db;
    public HrmBonusRunRepository(IApplicationDbContext db) => _db = db;
...
{
    private readonly IApplicationDbContext _db;
    public HrmBonusLineRepository(IApplicationDbContext db) => _db = db;
...
{
    private readonly IApplicationDbContext _db;
    public HrmBonusScopeDesignationRepository(IApplicationDbContext db) => _db = db;
...
{
    private readonly IApplicationDbContext _db;
    public HrmBonusScopeEmployeeRepository(IApplicationDbContext db) => _db = db;
...
{
    private readonly IApplicationDbContext _db;
    public HrmLoanAdvanceRepository(IApplicationDbContext db) => _db = db;
...
{
    private readonly IApplicationDbContext _db;
    public HrmFinalSettlementRepository(IApplicationDbContext db) => _db = db;
...
{
    private readonly IApplicationDbContext _db;
    public HrmLeaveApplicationRepository(IApplicationDbContext db) => _db = db;
...
{
    private readonly IApplicationDbContext _db;
    public HrmLeaveBalanceRepository(IApplicationDbContext db) => _db = db;
...
{
    private readonly IApplicationDbContext _db;
    public HrmLeaveLedgerRepository(IApplicationDbContext db) => _db = db;
...
{
    private readonly IApplicationDbContext _db;
    public HrmLeavePolicySetupRepository(IApplicationDbContext db) => _db = db;
...
{
    private readonly IApplicationDbContext _db;
    public HrmLeaveApplicationRuleRepository(IApplicationDbContext db) => _db = db;
...
{
    private readonly IApplicationDbContext _db;
    public HrmJobRequisitionRepository(IApplicationDbContext db) => _db = db;
...
{
    private readonly IApplicationDbContext _db;
    public HrmCandidateRepository(IApplicationDbContext db) => _db = db;
...
{
    private readonly IApplicationDbContext _db;
    public HrmOfferRepository(IApplicationDbContext db) => _db = db;
